...
#define ORG "izyy6o"// IBM ORGANIZATION ID
#define DEVICE_TYPE "iotdeviceproject"//DEVICE TYPE MENTIONED IN IOT WATSON PLATFORM
#define DEVICE_ID "229714"//DEVICE ID MENTIONED IN IOT WATSON PLATEFORM
...
void wificonnect()//function defenition for wificonnect
{
  ...
  WiFi.begin("Wokwi.GUEST", "",6);//PASSING THE WIFI CREDIDENTIALS TO ESTABLISH CONNECTION
